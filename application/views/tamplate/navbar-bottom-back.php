        ...
        <a href="<?= base_url() ?>search" class=" icon-soon align-items-center border-0 mx-2">
            <div class="icon-menus d-flex align-items-center home-svg py-0">
                <svg width="34" height="29" viewBox="0 0 34 29" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <rect x="0.787598" width="32.5366" height="29" rx="2" fill="#64DAFF"/>
                    <path d="M24.7876 22L20.9209 18.1333M15.8987 8.66667C18.3533 8.66667 20.3432 10.6565 20.3432 13.1111M23.0098 13.1111C23.0098 17.0385 19.8261 20.2222 15.8987 20.2222C11.9714 20.2222 8.7876 17.0385 8.7876 13.1111C8.7876 9.18375 11.9714 6 15.8987 6C19.8261 6 23.0098 9.18375 23.0098 13.1111Z" stroke="#0F4E97" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
            </div>
        </a>
    </div>
