...
<section id="" class="d-flex align-items-center p-3 pt-md-5">
    <div class="container">
        <div class="row">
            ...
            <div class="col-12 my-5 px-md-5">
                <div class="row">
                    <div class="col-12 col-md-7 mb-5 text-start mx-auto">
                        <h2 class="title-top-header f-hahmlet text-blue-freedy fw-bold" translate="no">No KYC & No AML</h2>
                    ...
                    <div class="col-12 col-md-5 d-none d-md-grid m-auto">
                        <img src="<?= base_url() ?>assets/img/speedybank/img-17.png" alt="" class="img-fluid">
                    </div>
                </div>
            </div>
            <?php } ?>
            ...
            <div class="col-12 my-5 px-md-5">
                <div class="row">
                    <div class="col-12 col-md-8 mb-5 text-start mx-auto">
                        <h2 class="title-top-header fw-bold f-hahmlet text-blue-freedy">Convert, custody and send worldwide in over 40 currencies
                        </h2>
                        ...
                        <div class="my-3 content-freedy text-start f-jakarta mt-4">
                            ...
                            <div class="c-check mt-5 ">
                                <ul class="p-0">
                                    ...
                                    <li>Send/withdraw funds by bank transfer to any bank account
                                        even if it is not under you name, everywhere in the world</li>
                                </ul>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-12 my-5 px-md-5">
                <div class="row">
                    ...
                    <div class="col-12 col-md-6 d-none d-md-grid m-auto">
                        <img src="<?= base_url() ?>assets/img/speedybank/img-22.png" alt="" class="img-fluid">
                    </div>
                </div>
            </div>
